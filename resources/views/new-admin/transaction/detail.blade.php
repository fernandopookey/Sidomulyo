                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $transaction->phone_number }}" class="form-control"
                                disabled>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($transaction->transactionDetails as $item)
                                <tr>
                                    ...
                                    <td>{{ !empty($item->product->name) ? $item->product->name : 'Product has been deleted' }}
                                    </td>
                                    {{-- <td>{{ $item->product->price }}</td> --}}
                                    <td>{{ !empty($item->product->price) ? $item->product->price : 'Product has been deleted' }}
                                    </td>
                                    <td>{{ $item->qty }}</td>
                                </tr>
                            @endforeach
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $transaction->user->fullname }}" class="form-control"
                                disabled>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $transaction->user->username }}" class="form-control"
                                disabled>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $transaction->user->email }}" class="form-control"
                                disabled>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            <label for="inputName">Address</label><br />
                            <input type="text" value="{{ $transaction->user->address }}" class="form-control"
                                disabled>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $transaction->user->roles }}" class="form-control"
                                disabled>
                        </div>
                    </div>
                </div>
