...
<script src="{{ asset('new-admin/js/popper.min.js') }}" defer></script>
<script src="{{ asset('new-admin/js/bootstrap.min.js') }}" defer></script>
<script src="{{ asset('new-admin/js/perfect-scrollbar.min.js') }}" defer></script>
<script src="{{ asset('new-admin/js/smooth-scrollbar.min.js') }}" defer></script>
