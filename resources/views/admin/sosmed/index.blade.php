            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram"
                            ...
                            value="{{ isset($sosmed) ? $sosmed->instagram : old('instagram') }}" autocomplete="off">
                        @error('instagram')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="whatsapp" class="form-control @error('whatsapp') is-invalid @enderror"
                            value="{{ isset($sosmed) ? $sosmed->whatsapp : old('whatsapp') }}" autocomplete="off">
                        @error('whatsapp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="facebook" class="form-control @error('facebook') is-invalid @enderror"
                            value="{{ isset($sosmed) ? $sosmed->facebook : old('facebook') }}" autocomplete="off">
                        @error('facebook')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="tokopedia"
                            ...
                            value="{{ isset($sosmed) ? $sosmed->tokopedia : old('tokopedia') }}" autocomplete="off">
                        @error('tokopedia')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="shopee" class="form-control @error('shopee') is-invalid @enderror"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="twiter" class="form-control @error('twiter') is-invalid @enderror"
