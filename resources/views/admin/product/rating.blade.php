    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <div class="rating">
                    @for ($i = 1; $i <= $ratenum; $i++) <img src="/images/stars.png" width="20" alt="">
                        @endfor
                        @for ($j = $ratenum + 1; $j <= 5; $j++) <img src="/images/star.png" width="20" alt="">
                            @endfor
                            <span>
                                @if ($rating->count() > 0)
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div class="user-review py-2">
                        ...
                        @endphp
                        @for ($i = 1; $i <= $user_rated; $i++) <img src="/images/stars.png" width="20" alt="">
                            @endfor
                            @for ($j = $user_rated + 1; $j <= 5; $j++) <img src="/images/star.png" width="20" alt="">
                                @endfor
                                @endif
